...
ui.move(64);
ui.turn(-40);	   // TURN LEFT      Turn the robot 40 degrees to the LEFT. (Negative numbers will turn the robot counter-clockwise.)
ui.setPenColor(91,178,198);			
ui.move(flameSize);		   // DRAW FLAME     Move the robot the distance in the variable flameSize
			
				//               Turn the robot 170 degrees
ui.turn(170);			
				//               Move the robot the distance in the variable flameSize (again)
ui.move(flameSize);	
ui.setPenColor(0,0,0);		
