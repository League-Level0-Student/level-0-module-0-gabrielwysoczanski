...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog("What is your adjective?");
		// Get the player to enter a type of liquid
String liquid=JOptionPane.showInputDialog("What is your liquid?");
		// Get the player to enter a body part
String bodypart=JOptionPane.showInputDialog("What is your body part?");
		// Get the player to enter a verb
String verb=JOptionPane.showInputDialog("What is your verb?");
		// Get the player to enter a place
String place=JOptionPane.showInputDialog("What is your place?");
